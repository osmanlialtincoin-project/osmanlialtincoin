...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " osmanli_altin_coin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  osmanli_altin_coin-tx [options] <hex-tx> [commands]  Update hex-encoded osmanli_altin_coin transaction\n" +
            "or:     osmanli_altin_coin-tx [options] -create [commands]   Create hex-encoded osmanli_altin_coin transaction\n" +
            "\n";
