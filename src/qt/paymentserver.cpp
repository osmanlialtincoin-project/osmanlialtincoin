...
const QString BITCOIN_IPC_PREFIX("osmanli_altin_coin:");
#ifdef ENABLE_BIP70
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/osmanli_altin_coin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/osmanli_altin_coin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/osmanli_altin_coin-paymentrequest";
#endif
...
{
    QString name("Osmanli_altin_coinQt");
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(nullptr, tr("Payment request error"),
                tr("Cannot start osmanli_altin_coin: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("osmanli_altin_coin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'osmanli_altin_coin://' is not a valid URI. Use 'osmanli_altin_coin:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Osmanli_altin_coin address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
