...
"""Verify that starting osmanli_altin_coin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start osmanli_altin_coin with -h for help text")
        ...
        self.log.info("Start osmanli_altin_coin with -version for version information")
        ...
        self.log.info("Start osmanli_altin_coind with -fakearg to make sure it does not start")
