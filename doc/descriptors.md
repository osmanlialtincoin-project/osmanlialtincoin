# Support for Output Descriptors in Osmanli_altin_coin Core

Since Osmanli_altin_coin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `oac1...` for mainnet or `toac1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Osmanli_altin_coin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Osmanli_altin_coin Core wallets, a convenience function `combo` is
