...
These are the dependencies currently used by Osmanli_altin_coin Core. You can find instructions for installing them in the `build-*.md` file for your platform.
