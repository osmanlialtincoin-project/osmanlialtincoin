...
By default, Osmanli_altin_coin Core allows up to 125 connections to different peers, 8 of
...
limits are tiny. Keep in mind that osmanli_altin_coin's trustless model works best if you are
