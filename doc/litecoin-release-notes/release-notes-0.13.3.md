Osmanli_altin_coin Core version 0.13.3 is now available from:

  <https://download.osmanli_altin_coin.org/osmanli_altin_coin-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/osmanli_altin_coin-project/osmanli_altin_coin/blob/0.13/src/chainparams.cpp#L214).
