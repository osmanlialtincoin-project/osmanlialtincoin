...
bech32_templates = [
  ...
  ('oac',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('oac',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('oac',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('toac',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('toac',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('toac',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('roac',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('roac',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('roac', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('toac',  17, 32, False, False, False),
  ('roac',  3,  1, False, False, False),
  ('oac',   15, 41, False, False, False),
  ('toac',  0, 16, False, False, False),
  ('roac',  0, 32, True,  False, False),
  ('oac',   0, 16, True,  False, False),
  ('toac',  0, 32, False, True,  False),
  ('roac',  0, 20, False, False, True)
]
